...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <p>&copy; 2024 EduTech. Todos os direitos reservados.</p>
        <p>Endereço: Rua Exemplo, 123, Bairro Exemplo, Cidade Exemplo, Estado Exemplo, CEP 12345-678</p>
        <p>Telefone: (11) 1234-5678</p>
        <p>E-mail: [contato@edutech.com.br](mailto:contato@edutech.com.br)</p>
      </div>
    ...
    <div class="row2">
      <div class="col-md-12">
        <p>Desenvolvido por <a href="#" target="_blank">EduTech</a></p>
        <p>Copyright &copy; 2024 EduTech. Todos os direitos reservados.</p>
      </div>
    </div>
  </div>
</footer>
